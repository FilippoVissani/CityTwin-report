...
% scrivere che questo modulo è più complesso degli altri, perchè comprende: - un sensore; - un'entità che rappresenta una stazione di controllo che monitora più sensori; - una view per visualizzare lo stato della stazione di controllo e relativi sensori monitorati, con la possibilità di intervenire in caso di allagamento.
