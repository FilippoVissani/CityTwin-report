...
% aggiungere dettagli sulle piogge acide: che cosa sono, che cosa comportano, a cosa sono dovute, eccetera... insomma fare una panoramica che dia uno scopo di esistere a questo sensore.
% aggiungere dettagli sul sensore: 
%   le proprietà (nome, posizione), 
%   range di valori che può rilevare e quando li rileva.
% aggiungere dettagli sul modo di interagire con il resource actor. (come funziona il resource actor è gia stato spiegato)
