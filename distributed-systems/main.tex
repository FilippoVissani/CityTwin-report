...
A questo punto è possibile avviare i singoli moduli, di seguito viene fornito il un esempio di comando per avviare il modulo \textit{Core}:
...
Per automatizzare l'avvio del sistema è stato creato uno script, situato in \textit{./scripts/startup}, che compila, estrae ed avvia i moduli del cluster Akka con impostazioni predefinite.
...
Altrimenti, è possibile avviare i singoli moduli manualmente, dopo averli compilati ed estratti, come descritto nella sezione precedente.
